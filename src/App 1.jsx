...
function App() {
  ...
  const updateCategory =(category) =>{
    ...
    document.getElementById(category).style = "background-color : yellow ;"
  ...
  return (
    ...
    <div>
      { showQuiz ? <Quiz category={categoryNumber}/> : <TriviaCategory updateCategory={updateCategory} startQuiz={startQuiz} unableContinue= {disable}/> }
    </div>
    </>
  )
}
